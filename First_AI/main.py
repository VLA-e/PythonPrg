...
# ================= metod kotoii ocenivaet ka4estvo==============================
def MSE(y, Y):
    return np.mean((y - Y) ** 2)  # srednekwadrati4naya 4em bolshe oshibka tem bolshe zna4enie i naoborot
...
print('gewichtten tussen eerste en tweede lag %s\n\r' % network.weights_0_1)
print('gewichtten tussen  tweede en derde lag %s\n' % network.weights_1_2)
